...
import 'package:socibip/features/post/controller/post_controller.dart';
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                /// Отвечает за раздачу "Наград".
                                /// Работает не коректно, после раздачи наград, они на перый раз пропадают у раздававшего,
                                /// после перекомпеляции приложения они вновь появляются
                                // IconButton(
                                //   onPressed: isGuest
                                //       ? () {}
                                //       : () {
